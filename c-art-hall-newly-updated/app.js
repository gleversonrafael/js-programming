...
function callEvents() {
    document.querySelector("form#newArt").addEventListener("submit", (submit) => {
...
function insertNewArt(){
    let elements = Array.from(document.querySelectorAll(".artAttributeJS"));
